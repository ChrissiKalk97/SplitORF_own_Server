...
def main(TIS_results, SO_results, Ribo_coverage_path, RiboTISH_path, Ensembl_canonical_path='', k4neo_path=''):
    ...
    k4neo_TransAI_preds = df_merged[df_merged['OrfTransID'].isin(
        k4neo_validated_transcripts)]
    Non_k4neo_TransAI_preds = df_merged[~df_merged['OrfTransID'].isin(
        k4neo_validated_transcripts)]
    ...
    # ------------------ WILOCXON RANK SUM TEST FOR THE BEST STARTS ------------------ #
    wilcoxon_rank_sums(Non_k4neo_TransAI_preds,
                       k4neo_TransAI_preds, 'second_best')
...
if __name__ == "__main__":
    ...
    print(TIS_results, SO_results, Ribo_coverage_path,
