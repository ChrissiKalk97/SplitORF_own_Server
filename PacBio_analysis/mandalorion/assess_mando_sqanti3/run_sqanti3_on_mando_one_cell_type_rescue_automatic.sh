...
mkdir -p "${sqanti_dir}"/SQANTI3_Rescue_automatic
...
if [ ! -d "${sqanti_dir}"/SQANTI3_Rescue_automatic/${cell_type} ]; then
    mkdir "${sqanti_dir}"/SQANTI3_Rescue_automatic/${cell_type}
    bash ${script_dir}/sqanti3/sqanti_rescue/sqanti_rescue_automatic.sh \
        /home/ckalk/tools/sqanti3.6 \
        ...
        "${sqanti_dir}"/SQANTI3_Rescue_automatic/${cell_type}
fi

if [ ! -d "${sqanti_dir}"/SQANTI3_Rescue_automatic/${cell_type}/QC ]; then
    mkdir "${sqanti_dir}"/SQANTI3_Rescue_automatic/${cell_type}/QC
    bash ${script_dir}/sqanti3/sqanti3_qc_mando_cm.sh \
    /home/ckalk/tools/sqanti3.6 \
    "${sqanti_dir}"/SQANTI3_Rescue_automatic/${cell_type}/${cell_type}_rescue_rules_filter_rescued.gtf \
    ${reference_gtf} \
    ${genome_fasta} \
    "${sqanti_dir}"/SQANTI3_Rescue_automatic/${cell_type}/QC
fi
