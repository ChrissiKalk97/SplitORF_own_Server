...
bash /home/ckalk/scripts/SplitORFs/PacBio_analysis/run_stringtie3_new_version_LRs_minimap2_rescue_automatic_25_08_26.sh
...
bash run_mandalorion_params_rescue_automatic_25_08_26.sh \
...
# ------------------ Run Isoquant                            ------------------ #
#################################################################################
bash /home/ckalk/scripts/SplitORFs/PacBio_analysis/IsoQuant/IsoQuant_analysis_rescue_automatic_25_08_26.sh

#################################################################################
# ------------------ TAMA merge final annotations            ------------------ #
#################################################################################

bash /home/ckalk/scripts/SplitORFs/PacBio_analysis/merge_stringtie_mando_isoquant/merge_stringtie_mando_isoquant_filter_and_rescue_automatic_25_08_26.sh