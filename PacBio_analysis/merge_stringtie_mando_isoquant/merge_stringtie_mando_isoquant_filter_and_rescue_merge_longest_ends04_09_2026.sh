...
outdir_tama="/projects/splitorfs/work/PacBio/merged_bam_files/merge_mando_stringtie_isoquant_rescue_up_1500_down_1000_longest_ends_05_09_2026"


bash /home/ckalk/scripts/SplitORFs/PacBio_analysis/merge_stringtie_mando_isoquant/tama_steps_with_isoquant_rescue_longest_ends_04_09_26.sh \
 -c HUVEC \
 -d "$script_dir" \
 -f "$genome_fasta" \
...
for cell_type in "HUVEC" "CM"; do
    if [[ ! -e "~/tools/SplitORF_pipeline/Input2023/HUVEC_CM_assemblies/${cell_type}_merged_tama_ExonCoordsOfTranscriptsForSO.txt" ]]; then
        python /home/ckalk/scripts/SplitOrfs/split-orf-prediction/Input_scripts/change_fasta_header_custom_isoforms.py \
            "$outdir_tama"/${cell_type}/${cell_type}_merged_tama_gene_id_04_09_26.gtf \
    ...
    if [[ ! -d "$outdir_tama"/${cell_type}/${cell_type}_quant ]]; then
        ...
        isoquant \
            ...
            --genedb "$outdir_tama"/${cell_type}/${cell_type}_merged_tama_gene_id_04_09_26.gtf \
...
for cell_type in "HUVEC" "CM"; do
    if [[ ! -e ""$outdir_tama"/${cell_type}/${cell_type}_LR_SR_support_filtered.gtf" ]]; then
        python filter_junction_chain_sr_or_lr_support_26_08_26.py \
            ...
            --custom_gtf "$outdir_tama"/${cell_type}/${cell_type}_merged_tama_gene_id_04_09_26.gtf \
