...
outdir_tama="/projects/splitorfs/work/PacBio/merged_bam_files/merge_mando_stringtie_isoquant_rescue_up_2000_down_500_longest_ends_05_09_2026"


bash /home/ckalk/scripts/SplitORFs/PacBio_analysis/merge_stringtie_mando_isoquant/tama_steps_with_isoquant_rescue_500_2000_07_09_26.sh \
 -c HUVEC \
 -d "$script_dir" \
 -f "$genome_fasta" \
