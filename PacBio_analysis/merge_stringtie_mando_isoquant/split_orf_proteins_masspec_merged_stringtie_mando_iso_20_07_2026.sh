...
tama_so_cm_dir="run_26.06.2026-21.42.22_CM_mando_iso_stringtie_rescued"
tama_so_huvec_dir="run_27.06.2026-00.21.52_HUVEC_mando_iso_stringtie_rescued"
RI_so_dir="run_07.04.2026-16.05.28_NMD_cont_subtraction"
NMD_so_dir="run_07.04.2026-16.10.51_RI_contamination_subtraction"
masspec_dir="tama_merged_iso_strin_mando_NMD_RI_masspec_files_20_07_26"
...
python ${script_path}/get_unique_ids_for_orfs_for_masspec_assembly_names.py \
 ...
 "${so_path}/${masspec_dir}/Unique_proteins_Masspec_NMD_RI_HUVEC_CM_tama_unique_SO_ID_20_07_26.fasta" \
 "SplitOrfProtein"
...
python ${script_path}/merge_reference_splitorf_prots_for_masspec.py \
 ...
 "${so_path}/${masspec_dir}/Unique_proteins_Masspec_NMD_RI_HUVEC_CM_tama_unique_SO_ID_20_07_26.fasta" \
 "${so_path}/${masspec_dir}/Unique_proteins_Masspec_NMD_RI_HUVEC_CM_tama_with_Uniprot_408_ref_unique_SO_ID_with_assembly_info_20_07_26.fasta"
