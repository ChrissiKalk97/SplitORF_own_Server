...
UNIQUE_REGION_DIR="/home/ckalk/tools/SplitORF_pipeline/Output/run_12.09.2025-17.51.04_HUVEC_tama_merged"
...
#     echo $sample_name
#     source ./empirical_intersection_steps_23_09_25.sh \
#         $i \
#         $UNIQUE_REGION_DIR/Unique_DNA_Regions_genomic.bed \
#         $THREE_PRIMES \
...
R -e 'library(rmarkdown); rmarkdown::render(input = "RiboSeqReportGenomic_iteration_update_single_23_09_25.Rmd", output_file = "/projects/splitorfs/work/Riboseq/Output/Riboseq_genomic_single_samples/resample_q10_huvec_tama_19_09_25/Riboseq_report_TAMA_HUVEC.pdf", params=list(args = c("/projects/splitorfs/work/Riboseq/Output/Riboseq_genomic_single_samples/resample_q10_huvec_tama_19_09_25", "/home/ckalk/tools/SplitORF_pipeline/Output/run_12.09.2025-17.51.04_HUVEC_tama_merged", "HUVEC_TAMA")))'
