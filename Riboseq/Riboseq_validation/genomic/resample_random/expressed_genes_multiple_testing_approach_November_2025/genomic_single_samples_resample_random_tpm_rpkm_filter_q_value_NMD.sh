...
echo "${file_dir}/RiboseQC/ORFquant/RiboseQC/$(basename ${i})_04_08_25.html"
if [[ ! -e "${file_dir}/RiboseQC/ORFquant/RiboseQC/$(basename ${i})_04_08_25.html" ]]; then
    bash /home/ckalk/scripts/SplitORFs/Riboseq/Michi_Vlado_round_1/Riboseq_pipeline.sh \
        -i  "${UMI_dedup_outdir}" \
        -o "${file_dir}/RiboseQC" \
        -g "${ensembl_gtf}" \
