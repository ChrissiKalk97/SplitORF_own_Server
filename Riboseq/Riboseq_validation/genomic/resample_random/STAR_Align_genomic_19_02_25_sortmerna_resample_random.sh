...
outputsortmerna="/projects/splitorfs/work/Riboseq/Output/contamination_mapping/SortMeRNA/all"
rRNA_path="/projects/splitorfs/work/Riboseq/data/contamination/rRNA_transcripts_113.fasta"
mtrRNA_path="/projects/splitorfs/work/Riboseq/data/contamination/mtrRNA_transcripts_113.fasta"
mttRNA_path="/projects/splitorfs/work/Riboseq/data/contamination/mttRNA_transcripts_113.fasta"
snRNA_path="/projects/splitorfs/work/Riboseq/data/contamination/snRNA_transcripts_113.fasta"
snoRNA_path="/projects/splitorfs/work/Riboseq/data/contamination/snoRNA_transcripts_113.fasta"
...
sortmerna --workdir $outputsortmerna/${sample} -fastx $outputsortmerna/${sample}_aligned\
 -other $outputsortmerna/${sample}_unaligned -ref $rRNA_path -ref $mtrRNA_path\
  -ref $mttRNA_path -ref $snRNA_path -ref $snoRNA_path -reads $Riboreads
...
STAR\
 ...
 --genomeDir $StarIndex\
 --readFilesIn $outputsortmerna/${sample}_unaligned.fq\\
 --twopassMode Basic\
