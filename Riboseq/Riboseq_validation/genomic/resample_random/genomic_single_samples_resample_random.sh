...
R -e 'library(rmarkdown); rmarkdown::render(input = "RiboSeqReportGenomic_iteration.Rmd", output_file = "/projects/splitorfs/work/Riboseq/Output/Riboseq_genomic_single_samples/resample/Riboseq_report_genomic_iteration_q10_16_06_25.pdf", params=list(args = c("/projects/splitorfs/work/Riboseq/Output/Riboseq_genomic_single_samples/resample", "/projects/splitorfs/work/LLMs/TIS_transformer/Input/SO_pipeline_results")))'