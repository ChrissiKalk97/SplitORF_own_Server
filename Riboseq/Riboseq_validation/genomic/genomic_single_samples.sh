...
R -e "library(rmarkdown); rmarkdown::render(input = 'RiboSeqReportGenomic_empirical_dist.Rmd', output_file = '$outputSTAR/Riboseq_report_genomic.pdf', params=list(args = c('$outputSTAR')))"
