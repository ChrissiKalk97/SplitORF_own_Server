...
Ensembl_genomic_three_primes = Ensembl_genomic_three_primes[Ensembl_genomic_three_primes['Transcript stable ID'].isin(tsl_filtered_prot_cod_tids)]
Ensembl_genomic_three_primes['ID'] = Ensembl_genomic_three_primes['Gene stable ID'] + '|' + Ensembl_genomic_three_primes['Transcript stable ID'] 
print(Ensembl_genomic_three_primes.columns)
Ensembl_genomic_three_primes = Ensembl_genomic_three_primes[['Chromosome/scaffold name',  "3' UTR start",  "3' UTR end", 'Strand', 'ID']]
