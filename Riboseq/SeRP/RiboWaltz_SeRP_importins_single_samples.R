...
plot_dir = '/projects/serp/work/Output/April_2025/importins/transcriptome_mapping/Ribowaltz'
...
reads_list <- bamtolist(bamfolder = "/projects/serp/work/Output/April_2025/importins/transcriptome_mapping/filtered/q10", annotation = annotation_df)
